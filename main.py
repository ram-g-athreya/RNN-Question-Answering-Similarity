...
def main():
    ...
    if os.path.isfile(train_file):
        ...
        train_dataset = LC_QUAD_Dataset(master_data_dir, train_dir, vocab_toks, vocab_pos, vocab_rels, args.num_classes)
    ...
    if os.path.isfile(test_file):
        ...
        test_dataset = LC_QUAD_Dataset(master_data_dir, test_dir, vocab_toks, vocab_pos, vocab_rels, args.num_classes)
